...
function saveChannelObj(channel_path, channel_name){
	...
	chrome.runtime.sendMessage({method: "saveChannel", channelObj: channelObj}, function(response) {
...
function loadChannels(){
	...
	chrome.runtime.sendMessage(null, {method: "loadChannels", origin_url: origin_url}, null, function(chrome_response) {
...
function loadChannels () {
	...
	chrome.runtime.sendMessage({method: "loadChannels", origin_url: origin_url}, function(chrome_response) {
		console.log('loadChannels callback');
		console.log(chrome_response);

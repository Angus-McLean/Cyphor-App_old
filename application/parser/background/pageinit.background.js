...
var CyphorMessageClient = new MessageClient({
	buildDownFunction : function (proxyInitMsg) {
		var originTabId = (proxyInitMsg._origin && proxyInitMsg._origin.tabId);
		return function (msgToProxy) {
				chrome.tabs.sendMessage(originTabId, msgToProxy);
			};
	}
});
...
chrome.browserAction.onClicked.addListener(function (tab) {
	...
	// use the CyphorMessageClient layer
	CyphorMessageClient.send('PARSE_CHANNEL', {
		event : 'init'
	}, function (msgObj) {
